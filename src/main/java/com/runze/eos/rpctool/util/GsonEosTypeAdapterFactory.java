...
import com.runze.eos.rpctool.domain.AccountName;
import com.runze.eos.rpctool.domain.ActionName;
import com.runze.eos.rpctool.domain.Name;
import com.runze.eos.rpctool.domain.PermissionName;
...
public class GsonEosTypeAdapterFactory implements TypeAdapterFactory {
    ...
    {
        adapters.put(Name.class, new TypeNameAdapter<>( Name.class));
        adapters.put(AccountName.class, new TypeNameAdapter<>( AccountName.class));
        adapters.put(ActionName.class, new TypeNameAdapter<>( ActionName.class));
        adapters.put(PermissionName.class, new TypeNameAdapter<>( PermissionName.class));
